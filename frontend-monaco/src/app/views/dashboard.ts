...
import { hasDraft, truncate } from '../shared';
          ...
          @for (c of challenges(); track c.challengeId) {
            <article class="card">
              ...
              <div class="card-footer">
                @if (role() === 'ALUMNO') {
                  @if (hasDraft(c.challengeId)) {
                    <button type="button" class="btn btn-primary" (click)="open(c)">
                      Continuar
                    </button>
                  } @else {
                    <button type="button" class="btn btn-primary" (click)="askSolve(c)">
                      Resolver
                    </button>
                  }
                } @else {
...
export class DashboardComponent implements OnInit {
  ...
  protected readonly hasDraft = hasDraft;
